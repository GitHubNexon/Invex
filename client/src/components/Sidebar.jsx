...
const Sidebar = () => {
  ...
  return (
    ...
    >
      <div
        ref={sidebarRef}
        className="bg-blue-500 text-white p-5 space-y-6 shadow-lg flex flex-col w-full"
      >
        <button
        ...
        <div className="mb-4">
          <Link
            to="/"
            className={`flex items-center space-x-3 p-2 rounded-md hover:bg-blue-700 ${
              location.pathname === "/" ? "bg-blue-300 text-gray-800" : ""
        ...
        <button
          ...
          className={`flex items-center space-x-3 p-2 rounded-md hover:bg-blue-600 mt-auto bg-blue-500 text-white ${
            isOpen ? "pl-5" : "justify-center"
          }`}
        >
          <div
